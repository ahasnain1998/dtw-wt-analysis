...
directory = '/media/obiwan/Elements/Sohraby/TauRAMD-MainRun/CO/WT/TIT-WT/contacts_chain_A'
...
results_df.to_csv('counts_results-wT-A.csv', index=False, columns=residue_columns.insert(0, 'Filename'))
